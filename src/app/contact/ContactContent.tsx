        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-6">
              <address className="not-italic bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-white mb-1">WhatsApp & Phone</h3>
                      <p className="text-slate-400 text-sm flex flex-col gap-1 mt-1">
                        ...
                        <a href="https://wa.me/918617651623" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 transition-colors font-medium">WhatsApp: 8617651623</a>
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-slate-900/80 border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden backdrop-blur-md">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5 relative z-10" noValidate>
                ...
                <fieldset className="flex flex-col gap-2 border-0 p-0 m-0">
                  <legend className="text-sm text-slate-400 font-medium mb-2">What are you looking for?</legend>
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      type="button"
                      onClick={() => { setInquiryType("service"); setSelection(""); }}
                      aria-pressed={inquiryType === "service"}
                    ...
                    <button
                      type="button"
                      onClick={() => { setInquiryType("product"); setSelection(""); }}
                      aria-pressed={inquiryType === "product"}
                ...
                >
                  {formStatus === "submitting" ? (
                    ...
                    <>Send to WhatsApp <Send size={18} aria-hidden="true" /></>
                  )}
                </button>
              </form>
            </div>
